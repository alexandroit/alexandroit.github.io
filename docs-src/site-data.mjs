...
export const projects = [
  ...
  },
  {
    ...
    docsUrl: "https://alexandro.net/docs/react/multiselect/react-19/",
    ...
    i18n: {
      en: {
        ...
        releaseLine: "React 19 family",
        summary:
          "A maintained React 19 multiselect dropdown with controlled state, slots, headless hooks, searchable object data, live demos, and accessibility-focused keyboard/ARIA behavior.",
        highlights: ["Headless hooks", "Docs live", "Published on npm"],
      },
      pt: {
        family: "Formulários",
        releaseStatus: "Pacote público no npm",
        releaseLine: "Família React 19",
        summary:
          "Um multiselect dropdown React 19 mantido, com estado controlado, slots, hooks headless, dados em objeto, demos ao vivo e comportamento de teclado/ARIA testado.",
        highlights: ["Hooks headless", "Docs no ar", "Publicado no npm"],
      },
      fr: {
        family: "Formulaires",
        releaseStatus: "Package public sur npm",
        releaseLine: "Famille React 19",
        summary:
          "Un multiselect dropdown React 19 maintenu, avec état contrôlé, slots, hooks headless, données objet, démos en ligne et comportement clavier/ARIA testé.",
        highlights: ["Hooks headless", "Docs en ligne", "Publié sur npm"],
      },
    },
  },
  {
